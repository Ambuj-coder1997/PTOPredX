...
def show_predict_page():
    ...
    st.markdown("<h1 style='text-align: center; color: DarkGoldenRod;'>PTOPredX</h1>", unsafe_allow_html=True)
    st.markdown("<h2 style='text-align: center; color: DarkGreen;'> Cloud-hosted Serverless System for Instantaneous Tractor Engine PTO power prediction </h2>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: left; color: DarkRed;'>Input the following tractor parameters for predicting the real-time PTO Power of tractor : </h3>", unsafe_allow_html=True)
